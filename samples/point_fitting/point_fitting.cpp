...
Point Fitting Sample

-> Useless algorithm. Tries to find the position of a point
	using differential evolution :P
-> It's a simple thing to hunt for bugs
-> Can be used as a framework to expand to others problems
